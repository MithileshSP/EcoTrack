...
const Profile = ({ user, setUser, emissions = [] }) => {
  ...
  const handleDownload = React.useCallback(() => {
    ...
    link.href = url;
    link.download = `carbontracker-profile-${
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Download your carbon footprint data for external analysis or
                  backup.
                </p>
                <button
